...
function register($users, $received_data){
    ...
    if (0 <= count($users)) {
        $new_user = ["username" => $username, "password" => $password, "level" => 1, "popcorn" => 0, "gameInvites" => [] ,"friends" => [], "friendRequests" => [], "xpGoal" => 1000, "clues" => 0, "resetTimer" => 0, "profile_picture" => "Frame 621.png"];
